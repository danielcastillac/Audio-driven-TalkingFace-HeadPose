...
rasterize_triangles_module = tf.load_op_library(
    ...
    os.path.join('/content/Audio-driven-TalkingFace-HeadPose/Deep3DFaceReconstruction',#os.path.join('/home4/yiran/TalkingFace/Pipeline/Deep3DFaceReconstruction',
